...
AAC_DECODER_ERROR FADAACDecoder::init() {
...
AAC_DECODER_ERROR FADAACDecoder::enqueue(void* buffer, DWORD buffer_size, uint64_t aTimestamp) {
    if (buffer_size == 0) {
...
AAC_DECODER_ERROR FADAACDecoder::decode() {

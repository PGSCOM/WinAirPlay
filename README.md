Modify from [RPiPlay](https://github.com/FD-/RPiPlay) and [WinRTC](https://github.com/microsoft/winrtc/tree/master/patches_for_WebRTC_org/m84/src/modules/video_coding/codecs/h264/win)
